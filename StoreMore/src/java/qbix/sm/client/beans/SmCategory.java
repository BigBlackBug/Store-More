...
public class SmCategory implements IsSerializable{
    ...
    private HashSet<SmCategory> childs;
    ...
    public HashSet<SmCategory> getChilds() {
        return childs;
    }

    public void setChilds(HashSet<SmCategory> childs) {
        this.childs = childs;
    }
    ...
    public String toString() {
        return id+", "+name+", parentId:"+parentId+"subCategories:"+childs.toString()+",  files:"+files.toString();
    }
}
